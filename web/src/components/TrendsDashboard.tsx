          ...
          <tbody>
            ...
            {rows.map((r, i) => (
              <tr key={`${r.system_id}-${r[idKey]}`}>
                ...
                <td className="mono" style={{ textAlign: 'right' }}>{formatDuration(r.airtime_ms)}</td>
        ...
        <div className={loading ? 'is-refetching' : ''} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="glass-panel" style={{ padding: '12px 16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 32, gap: 8, flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: '0.72rem', color: 'var(--text-dim)' }}>Click a day (or drag across several) to open it in History</span>
            </div>
            <BarTimeline
              height={140}
